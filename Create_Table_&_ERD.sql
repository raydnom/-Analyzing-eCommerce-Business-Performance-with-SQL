...
CREATE TABLE IF NOT EXISTS public.order_item_dataset
(
...
(
    ...
    eview_comment_message character varying COLLATE pg_catalog."default",
...
ALTER TABLE IF EXISTS public.order_item_dataset
...
ALTER TABLE IF EXISTS public.orders_dataset
    ADD FOREIGN KEY (order_id)
    REFERENCES public.order_item_dataset (order_id) MATCH SIMPLE
    ON UPDATE NO ACTION
    ON DELETE NO ACTION
    NOT VALID;
...
ALTER TABLE IF EXISTS public.product_dataset
    ...
    REFERENCES public.order_item_dataset (product_id) MATCH SIMPLE
    ON UPDATE NO ACTION
    ON DELETE NO ACTION
    NOT VALID;
